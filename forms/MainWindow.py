...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._tamu_action = self.add_action("Tamu", "tamu", "Data Tamu", True, self.on_tamu_file)
        self._registrasi_action = self.add_action("Registrasi", "registrasi", "Data Registrasi", True, self.on_registrasi)
        self._keluar_action = self.add_action("Keluar", "keluar", "Data Keluar", True, self.on_keluar)
    ...
    def init_ribbon(self):
        ...
        file_pane.add_ribbon_widget(RibbonButton(self, self._tamu_action, True))

        edit_panel = home_tab.add_ribbon_pane("Edit")
        edit_panel.add_ribbon_widget(RibbonButton(self, self._registrasi_action, True))
        edit_panel.add_ribbon_widget(RibbonButton(self, self._keluar_action, True))
    ...
    def on_tamu_file(self):
        tamu_on(self)

    def on_save_to_excel(self):
        pass
  
    def on_registrasi(self):
        registrasi_on(self)
